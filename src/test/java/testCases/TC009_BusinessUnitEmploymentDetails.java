...
public class TC009_BusinessUnitEmploymentDetails extends BaseClass {
    ...
    public void verify_EmploymentDetails()
    {
        ...
        be.selectFile("Employment Form", 1);
        be.selectFile("Employee NDA Form", 1);
        be.selectFile("Declaration Against Bribery And Corruption", 1);
        be.selectFile("Induction Form", 1);
        be.selectFile("BGV Form", 1);
        be.selectFile("Insurance(GMC & GPA Sheet)", 1);
        be.selectFile("Declaration For Healthcare Coverage", 1);
        be.selectFile("PF Composite Form", 1);
        be.selectFile("PF Exemption Form", 1);
        be.selectFile("PF Nominee & Declaration Form", 1);
        be.selectFile("Gratuity Form", 1);
        be.selectFile("Esic Form", 1);
